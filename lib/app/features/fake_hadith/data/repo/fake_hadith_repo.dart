...
class FakeHadithRepo {
  ...
  Future<FakeHadithResponse> getFakeHadithById(String id) async {
    try {
      final response = await _dio.get('/fake-ahadith/$id');

      return FakeHadithResponse.fromJson(response.data as Map<String, dynamic>);
      ...
      throw Exception('Failed to load fake hadith');
    }
  }
